...
public class CustomClassLoader extends ClassLoader {
	...
	/**
	 *一般而言不推荐重写loadClass和defineClass方法，推荐重写findClass方法
	 * classloader的loadclass逻辑:1.找loading class缓存;2.找父classloader的loadeclass方法;3.找自己的findclass方法；
	 * 这里进行重写，断绝双亲委派模式，直接判断
	 */
	@Override
