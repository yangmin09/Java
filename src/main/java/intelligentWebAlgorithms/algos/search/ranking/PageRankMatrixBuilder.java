 ...
 *   
 */
package intelligentWebAlgorithms.algos.search.ranking;

import java.util.List;
import java.util.Set;

import intelligentWebAlgorithms.util.internet.crawling.core.CrawlData;
import intelligentWebAlgorithms.util.internet.crawling.core.CrawlDataProcessor;
import intelligentWebAlgorithms.util.internet.crawling.db.KnownUrlDB;
import intelligentWebAlgorithms.util.internet.crawling.db.PageLinkDB;
