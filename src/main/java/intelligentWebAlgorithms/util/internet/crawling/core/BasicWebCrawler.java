 ...
 *   
 */
package intelligentWebAlgorithms.util.internet.crawling.core;

import intelligentWebAlgorithms.util.P;
import intelligentWebAlgorithms.util.internet.crawling.db.FetchedDocsDB;
import intelligentWebAlgorithms.util.internet.crawling.db.KnownUrlDB;
import intelligentWebAlgorithms.util.internet.crawling.db.ProcessedDocsDB;
import intelligentWebAlgorithms.util.internet.crawling.model.FetchedDocument;
import intelligentWebAlgorithms.util.internet.crawling.model.KnownUrlEntry;
import intelligentWebAlgorithms.util.internet.crawling.model.Outlink;
import intelligentWebAlgorithms.util.internet.crawling.transport.common.Transport;
import intelligentWebAlgorithms.util.internet.crawling.transport.common.TransportException;
import intelligentWebAlgorithms.util.internet.crawling.transport.file.FileTransport;
import intelligentWebAlgorithms.util.internet.crawling.transport.http.HTTPTransport;
import intelligentWebAlgorithms.util.internet.crawling.util.DocumentIdUtils;
import intelligentWebAlgorithms.util.internet.crawling.util.UrlGroup;
import intelligentWebAlgorithms.util.internet.crawling.util.UrlUtils;
import intelligentWebAlgorithms.util.parsing.common.*;
