 ...
 *   
 */
package intelligentWebAlgorithms.examples.credit.util;

import intelligentWebAlgorithms.algos.taxis.core.intf.Classifier;
import intelligentWebAlgorithms.examples.credit.data.UserDataset;
import intelligentWebAlgorithms.examples.credit.data.users.User;
import intelligentWebAlgorithms.algos.taxis.core.intf.Concept;
import intelligentWebAlgorithms.algos.taxis.core.intf.Instance;
import intelligentWebAlgorithms.examples.credit.BaggingCreditClassifier;
import intelligentWebAlgorithms.examples.credit.BoostingCreditClassifier;
import intelligentWebAlgorithms.examples.credit.CreditConcept;
import intelligentWebAlgorithms.examples.credit.DTCreditClassifier;
import intelligentWebAlgorithms.examples.credit.NBCreditClassifier;
import intelligentWebAlgorithms.examples.credit.NNCreditClassifier;
