 ...
 *   
 */
package intelligentWebAlgorithms.examples.credit.data;

import java.util.ArrayList;
import java.util.List;

import intelligentWebAlgorithms.examples.credit.util.CreditDataUtils;
import intelligentWebAlgorithms.config.YooreekaConfigurator;
import intelligentWebAlgorithms.examples.credit.data.users.BadUserType;
import intelligentWebAlgorithms.examples.credit.data.users.DangerousUserType;
import intelligentWebAlgorithms.examples.credit.data.users.ExcellentUserType;
import intelligentWebAlgorithms.examples.credit.data.users.GoodUserType;
import intelligentWebAlgorithms.examples.credit.data.users.User;
import intelligentWebAlgorithms.examples.credit.data.users.UserType;
import intelligentWebAlgorithms.examples.credit.data.users.VeryGoodUserType;
import intelligentWebAlgorithms.examples.credit.util.DataGenerator;
